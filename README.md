...
* **[Dificultad #3]:** Describa un desafío de coordinación o Git (ej. Conflictos al fusionar el archivo `.psc`).
    * **Solución:** Describa la solución (ej. Establecer reglas claras de *branching* y PRs).
...
AHJDJHSJSDGHJKDHASDKJHSDJKFHJKSDFHJKDSHFJKDSHF