...
SubProceso resultado <- Sumar(num1, num2)
	// Comentario: Lógica para realizar la suma y devolver el resultado.
FinSubProceso
		...
		SiNo
			...
			Segun opcion Hacer
				...
				1: // Operaciones Básicas
					...
					Escribir "Ha seleccionado Operaciones Básicas. (PENDIENTE DE IMPLEMENTAR). De ENTER para continuar";
